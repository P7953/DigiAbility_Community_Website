          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
            <div className="lg:col-span-8 flex flex-col gap-6">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <a
                  href="#download"
                  className="bg-stone-900 text-white hover:bg-stone-800 px-6 py-3.5 rounded-xl font-bold text-sm inline-flex items-center gap-3 transition-all hover:scale-105 shadow-md"
                >
                ...
                <a
                  href="#download"
                  className="bg-white hover:bg-stone-50 text-stone-900 border border-stone-300 px-5 py-3.5 rounded-xl font-bold text-sm inline-flex items-center gap-2 transition-colors shadow-xs"
                >
              ...
              <div className="flex flex-wrap gap-6 pt-4 text-xs font-semibold text-stone-600">
            ...
            <div className="lg:col-span-4 flex justify-center lg:justify-end">
              <div className="bg-white border border-purple-200/80 rounded-2xl p-6 flex flex-col items-center gap-4 text-center max-w-xs w-full shadow-md">
                <div className="w-36 h-36 bg-white p-3 rounded-xl flex items-center justify-center shadow-inner border border-stone-100">
                  {/* QR Code visual graphic */}
                  <div className="w-full h-full border-2 border-stone-900 rounded-lg p-2 flex flex-col justify-between items-center text-stone-900 font-mono text-[9px]">
